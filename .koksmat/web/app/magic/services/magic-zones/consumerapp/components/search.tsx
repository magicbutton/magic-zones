...
import ConsumerAppSmallCard from "./smallcard";
...
*/ 
    ...
    export interface Root {
        ...
        totalItems: number
        currentPage: number
        items: ConsumerAppItem[]
      }
   

    export default function SearchConsumerApp(
        props: {
          onItemClick? : (item:ConsumerAppItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ConsumerAppSmallCard item={item} 
